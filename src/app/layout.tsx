...
export const metadata: Metadata = {
  ...
  robots: { index: true, follow: true },
  verification: {
    google: '6KE8Qp5p0dXMp1etepmmhRmw7fG_SRwVuBampfeCL5M',
  },
}
...
export default function RootLayout({ children }: { children: ReactNode }) {
  return (
    <html lang="zh-TW" className={`${workSans.variable} ${notoSansTC.variable}`}>
      <head>
        <link
          rel="stylesheet"
      ...
      <body className="font-sans min-h-dvh bg-background pb-20 md:pb-0">
        <PreferencesHydrator />
        <ClientSettingsProviders />
        <ServiceWorkerRegistrar />
        <TopAppBar />
