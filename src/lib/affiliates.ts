...
export const AFFILIATE_OFFERS: AffiliateOffer[] = [
  // ---- 生鮮買菜網(與「查菜價→買菜」情境最相關,優先) ----
  {
    ...
    enabled: true,
    sponsored: false,
    title: 'up2you-保健{crop}',
    description: '希望以保健食品、最新的營養保健知識、讓大家愈來愈健康。',
    ctaLabel: '去買保健食品',
    url: 'https://afflink.one/s/oRwTQ',
    icon: 'shopping_cart',
    categories: FOOD,
    priority: 9,
    partner: 'up2you-保健',
  },
  {
    ...
    enabled: true,
    sponsored: false,
    title: 'Eternal永恆選物{crop}',
    description: '美食特產, 生鮮食品。',
    ctaLabel: '逛永恆選物',
    url: 'https://onelink.one/s/4Ucpq',
    icon: 'spa',
    categories: FOOD,
    priority: 9,
    partner: '永恆選物',
